...
<?php
if (!isset($argv['1'])) {
	echo "Use this script as: php addsuperuser.php USERNAME 0.0.0.0/0\n";
	exit;
}
...
if ($token = $manager->userCreate(['name' => $username, 'superuser' => true, 'allowed_ips' => [$allowed], 'expire_timestamp' => 0])) {
